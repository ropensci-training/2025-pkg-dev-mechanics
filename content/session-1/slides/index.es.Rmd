...
get_pic(id = 5446296, alt = "Rueda de bicicleta con herramientas en el piso", 200)
```
...
get_pic(id = 686230, alt = "Señal de bicicleta en un carril de bicicletas, con hojas de árbol.", 300)
```
